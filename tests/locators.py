...
class AddClientSelectors(object):
    ...
    ADD_LOGOUT_URI = (By.XPATH, '//input[@type="submit"][@value="Add Logout URI"]')
    LOGOUT_URI_INPUT = (By.ID, 'clientLogoutUri:j_idt1127:text:clientLogoutTextId')
    LOGOUT_URI_OK = (By.ID, 'clientLogoutUri:j_idt1127:j_idt1151')
    LOGOUT_URIS_DIV = (By.ID, 'clientForm:clientLogoutUrls')
    LOGOUT_URI_1 = (By.ID, 'clientForm:clientLogoutUrls:j_idt751:0:j_idt755')
    LOGOUT_URIS_SPAN = (By.ID, 'clientForm:clientLogoutUrls:selectedClientUrisId')
